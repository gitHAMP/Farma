...
public class VoucherServiceImpl implements VoucherService {
	...
	@Transactional(readOnly=true)
	@Override
	public Optional<Voucher> fetchByVoucherIdWithPatientWhithVoucherDetailWithMedicine(Long id) throws Exception {
		return voucherRepository.fetchByVoucherIdWithPatientWhithVoucherDetailWithMedicine(id);
	}
